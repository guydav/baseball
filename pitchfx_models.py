...
class AtBat(BaseModel):
    ...
    des = CharField()
    event = CharField()
    # To ease joining in the calculate entropy queries
    game_id = IntegerField(db_column='game_id', index=True)
    game = ForeignKeyField(Game, db_column='game_id', related_name='at_bats', index=True)
...
class Pitch(BaseModel):
    ...
    at_bat = ForeignKeyField(AtBat, db_column='ab_id', related_name='pitches', index=True)
